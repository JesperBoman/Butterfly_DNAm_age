#!/usr/bin/env Rscript
#For more information about the different steps, see fancier_varying_seed_clock5_F.R
...
#Removed filtering for correlated sites
...
cor.test(predicted.age, age_other$Age)
...
meth.final.predictors <- meth.final.impute[, setdiff(colnames(filteredDescr), "Age")]
